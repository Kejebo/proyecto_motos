...
<main id="main">
 ...
 <div class="container row" id="row_detalles_reparacion">
                            ...
                            <table class="table table-inverse|reflow|striped|bordered|hover|sm text-center">
                                ...
                                <tbody id="detail_work" style="background-color:white">
                                    ...
                                    if (isset($_GET['reparacion'])) {
                                        foreach ($this->ln_workshop->db->get_work_details($_GET['reparacion']) as $works) {
                        ...
                        <div class="card-body   table-responsive">
                            <table class="table table-bordered" width="100%">
                                ...
                                <tbody id="detail_material" class="text-center bg-white">
                                    ...
                                    $i = 0;
                                    if (isset($_GET['reparacion'])) {
                                        foreach ($this->ln_workshop->db->get_repair_details($_GET['reparacion']) as $material) {
                                    ?>
                                            <tr ids="<?= $i++ ?>">
